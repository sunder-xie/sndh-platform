...
public class RedisUtil {
    ...
    private static JedisPool getCache() {
    ...
    public static Long zcard(String key) {
        ...
        try {
            ...
            returnResource(jedis);
            RedisUtil.getCache().returnResource(jedis);
            e.printStackTrace();
        } finally {
            returnResource(jedis);
        }
...
//        RedisUtil ru = injector.getInstance(RedisUtil.class);
//        System.out.println("----redis:----:"+ru.set("user.id","032411"));

//        Jedis jedis = new Jedis("192.168.137.133",12002);
