...
/**
 *  ADDRESS_GUID_type0 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ADDRESS_GUID_type0 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ADDRESS_GUID_type0", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ADDRESS_GUID_type0", xmlWriter);
            }
        }
    ...
    public static class Factory {
        ...
        public static ADDRESS_GUID_type0 fromString(String value,
            String namespaceURI) {
            ADDRESS_GUID_type0 returnValue = new ADDRESS_GUID_type0();
        ...
        public static ADDRESS_GUID_type0 fromString(
         ...
         */
        public static ADDRESS_GUID_type0 parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            ADDRESS_GUID_type0 object = new ADDRESS_GUID_type0();
