...
public class ZSSD00068 implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for HIGH
     */
    protected HIGH_type3 localHIGH;
        ...
        public static ZSSD00068 parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ZSSD00068".equals(type)) {
                            ...
                            return (ZSSD00068) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "LOW").equals(
                            reader.getName())) {
                    object.setLOW(LOW_type3.Factory.parse(
                            reader));
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "HIGH").equals(
                            reader.getName())) {
                    object.setHIGH(HIGH_type3.Factory.parse(
                            reader));
