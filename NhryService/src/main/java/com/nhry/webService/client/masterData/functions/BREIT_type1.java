...
/**
 *  BREIT_type1 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class BREIT_type1 implements org.apache.axis2.databinding.ADBBean {
    ...
    /**
     * field for BREIT_type0
     */
    protected java.math.BigDecimal localBREIT_type0;

    /**
     * Auto generated getter method
     * @return java.math.BigDecimal
     */
    public java.math.BigDecimal getBREIT_type0() {
        return localBREIT_type0;
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":BREIT_type1", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "BREIT_type1", xmlWriter);
            }
        }

        if (localBREIT_type0 == null) {
            throw new org.apache.axis2.databinding.ADBException(
                "BREIT_type0 cannot be null !!");
        } else {
    ...
    public static class Factory {
        ...
        public static BREIT_type1 fromString(String value,
            String namespaceURI) {
            BREIT_type1 returnValue = new BREIT_type1();
        ...
        public static BREIT_type1 fromString(
         ...
         */
        public static BREIT_type1 parse(javax.xml.stream.XMLStreamReader reader)
            throws Exception {
            BREIT_type1 object = new BREIT_type1();
