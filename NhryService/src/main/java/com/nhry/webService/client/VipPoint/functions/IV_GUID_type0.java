...
/**
 *  IV_GUID_type0 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class IV_GUID_type0 implements org.apache.axis2.databinding.ADBBean {
    ...
    public String toString() {
        return localIV_GUID_type0.toString();
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":IV_GUID_type0", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "IV_GUID_type0", xmlWriter);
            }
        }

        if (localIV_GUID_type0 == null) {
    ...
    public static class Factory {
        ...
        public static IV_GUID_type0 fromString(String value,
            String namespaceURI) {
            IV_GUID_type0 returnValue = new IV_GUID_type0();
        ...
        public static IV_GUID_type0 fromString(
         ...
         */
        public static IV_GUID_type0 parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            IV_GUID_type0 object = new IV_GUID_type0();
