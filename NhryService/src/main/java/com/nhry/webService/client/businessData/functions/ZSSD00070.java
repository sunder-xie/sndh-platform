...
public class ZSSD00070 implements org.apache.axis2.databinding.ADBBean {
     ...
     * @param param HIGH
     */
    public void setHIGH(Date param) {
        ...
        public static ZSSD00070 parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ZSSD00070".equals(type)) {
                            ...
                            return (ZSSD00070) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "LOW").equals(
                            reader.getName())) {
                    object.setLOW(Date.Factory.parse(
                            reader));
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "HIGH").equals(
                            reader.getName())) {
                    object.setHIGH(Date.Factory.parse(
                            reader));
