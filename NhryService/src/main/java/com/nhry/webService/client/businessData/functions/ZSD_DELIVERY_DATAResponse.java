/**
 * ZSD_DELIVERY_DATAResponse.java
 *
...
/**
 *  ZSD_DELIVERY_DATAResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ZSD_DELIVERY_DATAResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:sap-com:document:sap:rfc:functions",
            "ZSD_DELIVERY_DATA.Response", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ZSD_DELIVERY_DATA.Response", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ZSD_DELIVERY_DATA.Response", xmlWriter);
            }
        }
