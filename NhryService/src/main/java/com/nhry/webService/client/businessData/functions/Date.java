...
public class Date extends org.apache.axis2.databinding.types.Union implements org.apache.axis2.databinding.ADBBean {
    ...
    public void setObject(java.lang.Object object) {
        ...
        } else if (object instanceof com.nhry.webService.client.businessData.functions.GenericDate) {
            this.localObject = object;
        } else {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localObject instanceof java.util.Date) {
        ...
        } else if (localObject instanceof com.nhry.webService.client.businessData.functions.GenericDate) {
            java.lang.String namespacePrefix = registerPrefix(xmlWriter,
            ...
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    (com.nhry.webService.client.businessData.functions.GenericDate) localObject));
        } else {
    ...
    public static class Factory {
        ...
        public static Date fromString(
            ...
            try {
                if ("http://www.w3.org/2001/XMLSchema".equals(namespaceURI)) {
                    ...
                    object = new Date();
                    object.setObject(com.nhry.webService.client.businessData.functions.ExtensionMapper.getTypeObject(
        ...
        public static Date fromString(java.lang.String value,
            ...
            if (!isValueSet) {
                try {
                    object.setObject(com.nhry.webService.client.businessData.functions.GenericDate.Factory.fromString(
                            value, namespaceURI));
                    isValueSet = true;
                } catch (java.lang.Exception e) {
                }
