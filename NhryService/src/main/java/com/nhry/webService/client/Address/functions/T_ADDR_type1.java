...
/**
 *  T_ADDR_type1 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class T_ADDR_type1 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":T_ADDR_type1", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "T_ADDR_type1", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static T_ADDR_type1 parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            T_ADDR_type1 object = new T_ADDR_type1();
