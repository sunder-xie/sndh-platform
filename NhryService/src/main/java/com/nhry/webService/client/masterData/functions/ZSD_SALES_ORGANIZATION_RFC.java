/**
 * ZSD_SALES_ORGANIZATION_RFC.java
 *
...
/**
 *  ZSD_SALES_ORGANIZATION_RFC bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ZSD_SALES_ORGANIZATION_RFC implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:sap-com:document:sap:rfc:functions",
            "ZSD_SALES_ORGANIZATION_RFC", "ns1");
     ...
     * field for ET_BUKRS
     */
    protected ET_BUKRS_type3 localET_BUKRS;

    /**
     * field for ET_LGORT
     */
    protected ET_LGORT_type3 localET_LGORT;

    /**
     * field for ET_T006A
     */
    protected ET_T006A_type1 localET_T006A;

    /**
     * field for ET_VKORG
     */
    protected ET_VKORG_type3 localET_VKORG;

    /**
     * field for ET_WERKS
     */
    protected ET_WERKS_type1 localET_WERKS;

    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.masterData.functions.IT_BUKRS_type2
     */
    ...
    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.masterData.functions.ET_BUKRS_type3
     */
    public ET_BUKRS_type3 getET_BUKRS() {
    ...
    public void setET_BUKRS(
        ET_BUKRS_type3 param) {
        this.localET_BUKRS = param;
    }

    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.masterData.functions.ET_LGORT_type3
     */
    public ET_LGORT_type3 getET_LGORT() {
    ...
    public void setET_LGORT(
        ET_LGORT_type3 param) {
        this.localET_LGORT = param;
    }

    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.masterData.functions.ET_T006A_type1
     */
    public ET_T006A_type1 getET_T006A() {
    ...
    public void setET_T006A(
        ET_T006A_type1 param) {
        this.localET_T006A = param;
    }

    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.masterData.functions.ET_VKORG_type3
     */
    public ET_VKORG_type3 getET_VKORG() {
    ...
    public void setET_VKORG(
        ET_VKORG_type3 param) {
        this.localET_VKORG = param;
    }

    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.masterData.functions.ET_WERKS_type1
     */
    public ET_WERKS_type1 getET_WERKS() {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ZSD_SALES_ORGANIZATION_RFC", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
    ...
    public static class Factory {
         ...
         */
        public static ZSD_SALES_ORGANIZATION_RFC parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            ZSD_SALES_ORGANIZATION_RFC object = new ZSD_SALES_ORGANIZATION_RFC();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ZSD_SALES_ORGANIZATION_RFC".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ZSD_SALES_ORGANIZATION_RFC) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "IT_BUKRS").equals(
                                    reader.getName())) {
                            object.setIT_BUKRS(IT_BUKRS_type2.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "ET_BUKRS").equals(
                                    reader.getName())) {
                            object.setET_BUKRS(ET_BUKRS_type3.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "ET_LGORT").equals(
                                    reader.getName())) {
                            object.setET_LGORT(ET_LGORT_type3.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "ET_T006A").equals(
                                    reader.getName())) {
                            object.setET_T006A(ET_T006A_type1.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "ET_VKORG").equals(
                                    reader.getName())) {
                            object.setET_VKORG(ET_VKORG_type3.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "ET_WERKS").equals(
                                    reader.getName())) {
                            object.setET_WERKS(ET_WERKS_type1.Factory.parse(
                                    reader));
