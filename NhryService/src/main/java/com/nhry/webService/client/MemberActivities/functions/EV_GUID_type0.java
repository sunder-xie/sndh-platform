...
/**
 *  EV_GUID_type0 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class EV_GUID_type0 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":EV_GUID_type0", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "EV_GUID_type0", xmlWriter);
            }
        }
    ...
    public static class Factory {
        ...
        public static EV_GUID_type0 fromString(String value,
            String namespaceURI) {
        ...
        public static EV_GUID_type0 fromString(
         ...
         */
        public static EV_GUID_type0 parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            EV_GUID_type0 object = new EV_GUID_type0();
