...
/**
 *  ZMM_POS_24DATA bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ZMM_POS_24DATA implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ZMM_POS_24DATA", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ZMM_POS_24DATA", xmlWriter);
            }
        }
