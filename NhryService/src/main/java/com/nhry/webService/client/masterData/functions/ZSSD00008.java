...
/**
 *  ZSSD00008 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ZSSD00008 implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for MAKTX
     */
    protected MAKTX_type1 localMAKTX;
     ...
     * @return com.nhry.webService.client.masterData.functions.MATNR_type3
     */
    ...
    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.masterData.functions.MAKTX_type1
     */
    public MAKTX_type1 getMAKTX() {
        return localMAKTX;
    }
     ...
     * @param param MAKTX
     */
    public void setMAKTX(MAKTX_type1 param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ZSSD00008", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ZSSD00008", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static ZSSD00008 parse(javax.xml.stream.XMLStreamReader reader)
            throws Exception {
            ZSSD00008 object = new ZSSD00008();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ZSSD00008".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ZSSD00008) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "MAKTX").equals(
                            reader.getName())) {
                    object.setMAKTX(MAKTX_type1.Factory.parse(
                            reader));
