...
public class ZSSD00001 implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for SIGN
     */
    protected SIGN_type3 localSIGN;
     ...
     * field for HIGH
     */
    protected HIGH_type1 localHIGH;
     ...
     * @param param SIGN
     */
    public void setSIGN(SIGN_type3 param) {
     ...
     * @param param LOW
     */
    public void setLOW(LOW_type1 param) {
     ...
     * @param param HIGH
     */
    public void setHIGH(HIGH_type1 param) {
        ...
        public static ZSSD00001 parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ZSSD00001".equals(type)) {
                            ...
                            return (ZSSD00001) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "SIGN").equals(
                            reader.getName())) {
                    object.setSIGN(SIGN_type3.Factory.parse(
                            reader));
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "OPTION").equals(
                            reader.getName())) {
                    object.setOPTION(OPTION_type3.Factory.parse(
                            reader));
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "LOW").equals(
                            reader.getName())) {
                    object.setLOW(LOW_type1.Factory.parse(
                            reader));
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "HIGH").equals(
                            reader.getName())) {
                    object.setHIGH(HIGH_type1.Factory.parse(
                            reader));
