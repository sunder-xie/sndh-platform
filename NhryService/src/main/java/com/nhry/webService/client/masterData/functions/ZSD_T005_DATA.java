...
/**
 *  ZSD_T005_DATA bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ZSD_T005_DATA implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for ET_BUKRS
     */
    protected ET_BUKRS_type0 localET_BUKRS;
     ...
     * field for ET_T005T
     */
    protected ET_T005T_type0 localET_T005T;
     ...
     * field for ET_T005U
     */
    protected ET_T005U_type0 localET_T005U;
     ...
     * field for ET_T024
     */
    protected ET_T024_type0 localET_T024;
     ...
     * field for ET_T024E
     */
    protected ET_T024E_type0 localET_T024E;
     ...
     * @return com.nhry.webService.client.masterData.functions.ET_BUKRS_type0
     */
    public ET_BUKRS_type0 getET_BUKRS() {
    ...
    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.masterData.functions.ET_T005T_type0
     */
    public ET_T005T_type0 getET_T005T() {
    ...
    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.masterData.functions.ET_T005U_type0
     */
    public ET_T005U_type0 getET_T005U() {
    ...
    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.masterData.functions.ET_T024_type0
     */
    public ET_T024_type0 getET_T024() {
        return localET_T024;
    }
    ...
    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.masterData.functions.ET_T024E_type0
     */
    public ET_T024E_type0 getET_T024E() {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ZSD_T005_DATA", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ZSD_T005_DATA", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ZSD_T005_DATA parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            ZSD_T005_DATA object = new ZSD_T005_DATA();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ZSD_T005_DATA".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ZSD_T005_DATA) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "ET_BUKRS").equals(
                                    reader.getName())) {
                            object.setET_BUKRS(ET_BUKRS_type0.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "ET_T005T").equals(
                                    reader.getName())) {
                            object.setET_T005T(ET_T005T_type0.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "ET_T005U").equals(
                                    reader.getName())) {
                            object.setET_T005U(ET_T005U_type0.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "ET_T024").equals(
                                    reader.getName())) {
                            object.setET_T024(ET_T024_type0.Factory.parse(
                                    reader));
                         ...
                         if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "ET_T024E").equals(
                                    reader.getName())) {
                            object.setET_T024E(ET_T024E_type0.Factory.parse(
                                    reader));
