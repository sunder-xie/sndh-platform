...
/**
 *  VOLUM_type1 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class VOLUM_type1 implements org.apache.axis2.databinding.ADBBean {
    ...
    /**
     * field for VOLUM_type0
     */
    protected java.math.BigDecimal localVOLUM_type0;

    /**
     * Auto generated getter method
     * @return java.math.BigDecimal
     */
    public java.math.BigDecimal getVOLUM_type0() {
        return localVOLUM_type0;
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":VOLUM_type1", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "VOLUM_type1", xmlWriter);
            }
        }

        if (localVOLUM_type0 == null) {
            throw new org.apache.axis2.databinding.ADBException(
                "VOLUM_type0 cannot be null !!");
        } else {
    ...
    public static class Factory {
        ...
        public static VOLUM_type1 fromString(String value,
            String namespaceURI) {
            VOLUM_type1 returnValue = new VOLUM_type1();
        ...
        public static VOLUM_type1 fromString(
         ...
         */
        public static VOLUM_type1 parse(javax.xml.stream.XMLStreamReader reader)
            throws Exception {
            VOLUM_type1 object = new VOLUM_type1();
