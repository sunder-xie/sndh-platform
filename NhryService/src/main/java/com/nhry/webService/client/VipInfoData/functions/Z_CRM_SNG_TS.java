...
public class Z_CRM_SNG_TS implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for IS_QUERY
     */
    protected com.nhry.webService.client.VipInfoData.functions.ZSCRM_SNG_TS_QUERY localIS_QUERY;
     ...
     */
    public com.nhry.webService.client.VipInfoData.functions.ZSCRM_SNG_TS_QUERY getIS_QUERY() {
    ...
    public void setIS_QUERY(
        com.nhry.webService.client.VipInfoData.functions.ZSCRM_SNG_TS_QUERY param) {
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if ((reader.isStartElement() &&
                                ...
                                new javax.xml.namespace.QName("", "IS_QUERY").equals(
                                    reader.getName())) {
                            object.setIS_QUERY(com.nhry.webService.client.VipInfoData.functions.ZSCRM_SNG_TS_QUERY.Factory.parse(
                                    reader));
