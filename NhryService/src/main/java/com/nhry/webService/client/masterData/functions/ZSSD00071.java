...
/**
 *  ZSSD00071 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ZSSD00071 implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for SIGN
     */
    protected SIGN_type5 localSIGN;
     ...
     * field for OPTION
     */
    protected OPTION_type5 localOPTION;
     ...
     * field for HIGH
     */
    protected HIGH_type5 localHIGH;
     ...
     * @return com.nhry.webService.client.masterData.functions.SIGN_type5
     */
    public SIGN_type5 getSIGN() {
        return localSIGN;
    }
    ...
    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.masterData.functions.OPTION_type5
     */
    public OPTION_type5 getOPTION() {
        return localOPTION;
    }
    ...
    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.masterData.functions.LOW_type5
     */
    public LOW_type5 getLOW() {
        return localLOW;
    }
     ...
     * @param param LOW
     */
    public void setLOW(LOW_type5 param) {
    ...
    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.masterData.functions.HIGH_type5
     */
    public HIGH_type5 getHIGH() {
        return localHIGH;
    }
     ...
     * @param param HIGH
     */
    public void setHIGH(HIGH_type5 param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ZSSD00071", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ZSSD00071", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static ZSSD00071 parse(javax.xml.stream.XMLStreamReader reader)
            throws Exception {
            ZSSD00071 object = new ZSSD00071();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ZSSD00071".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ZSSD00071) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "SIGN").equals(
                            reader.getName())) {
                    object.setSIGN(SIGN_type5.Factory.parse(
                            reader));
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "OPTION").equals(
                            reader.getName())) {
                    object.setOPTION(OPTION_type5.Factory.parse(
                            reader));
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "LOW").equals(
                            reader.getName())) {
                    object.setLOW(LOW_type5.Factory.parse(
                            reader));
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "HIGH").equals(
                            reader.getName())) {
                    object.setHIGH(HIGH_type5.Factory.parse(
                            reader));
