...
/**
 *  ZSSD00004 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ZSSD00004 implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for SIGN
     */
    protected SIGN_type1 localSIGN;
     ...
     * @return com.nhry.webService.client.masterData.functions.SIGN_type1
     */
    public SIGN_type1 getSIGN() {
        return localSIGN;
    }
     ...
     * @param param SIGN
     */
    public void setSIGN(SIGN_type1 param) {
    ...
    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.masterData.functions.OPTION_type1
     */
    ...
    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.masterData.functions.LOW_type1
     */
    ...
    /**
     * Auto generated getter method
     * @return com.nhry.webService.client.masterData.functions.HIGH_type1
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ZSSD00004", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ZSSD00004", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static ZSSD00004 parse(javax.xml.stream.XMLStreamReader reader)
            throws Exception {
            ZSSD00004 object = new ZSSD00004();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ZSSD00004".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ZSSD00004) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "SIGN").equals(
                            reader.getName())) {
                    object.setSIGN(SIGN_type1.Factory.parse(
                            reader));
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "OPTION").equals(
                            reader.getName())) {
                    object.setOPTION(OPTION_type1.Factory.parse(
                            reader));
