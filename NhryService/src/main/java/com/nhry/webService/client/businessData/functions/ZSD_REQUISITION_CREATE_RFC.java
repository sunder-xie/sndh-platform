/**
 * ZSD_REQUISITION_CREATE_RFC.java
 *
...
/**
 *  ZSD_REQUISITION_CREATE_RFC bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ZSD_REQUISITION_CREATE_RFC implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:sap-com:document:sap:rfc:functions",
            "ZSD_REQUISITION_CREATE_RFC", "ns1");
     ...
     */
    protected boolean localI_EKKOTracker = false;
    ...
    public boolean isI_EKKOSpecified() {
        return localI_EKKOTracker;
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ZSD_REQUISITION_CREATE_RFC", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ZSD_REQUISITION_CREATE_RFC", xmlWriter);
            }
        }

        if (localI_EKKOTracker) {
            if (localI_EKKO == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "I_EKKO cannot be null!!");
            }

            localI_EKKO.serialize(new javax.xml.namespace.QName("", "I_EKKO"),
                xmlWriter);
        }
