...
public class ZSSD00024 implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for WERKS
     */
    protected WERKS_type9 localWERKS;
     ...
     * field for NAME1
     */
    protected NAME1_type3 localNAME1;
     ...
     * field for LGOBE
     */
    protected LGOBE_type3 localLGOBE;
     ...
     * @param param WERKS
     */
    public void setWERKS(WERKS_type9 param) {
     ...
     * @param param NAME1
     */
    public void setNAME1(NAME1_type3 param) {
     ...
     * @param param LGOBE
     */
    public void setLGOBE(LGOBE_type3 param) {
        ...
        public static ZSSD00024 parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ZSSD00024".equals(type)) {
                            ...
                            return (ZSSD00024) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "WERKS").equals(
                            reader.getName())) {
                    object.setWERKS(WERKS_type9.Factory.parse(
                            reader));
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "NAME1").equals(
                            reader.getName())) {
                    object.setNAME1(NAME1_type3.Factory.parse(
                            reader));
                ...
                if ((reader.isStartElement() &&
                        ...
                        new javax.xml.namespace.QName("", "LGOBE").equals(
                            reader.getName())) {
                    object.setLGOBE(LGOBE_type3.Factory.parse(
                            reader));
