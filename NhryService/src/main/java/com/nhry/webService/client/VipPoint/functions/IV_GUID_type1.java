...
/**
 *  IV_GUID_type1 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class IV_GUID_type1 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":IV_GUID_type1", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "IV_GUID_type1", xmlWriter);
            }
        }
    ...
    public static class Factory {
        ...
        public static IV_GUID_type1 fromString(String value,
            String namespaceURI) {
        ...
        public static IV_GUID_type1 fromString(
         ...
         */
        public static IV_GUID_type1 parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            IV_GUID_type1 object = new IV_GUID_type1();
