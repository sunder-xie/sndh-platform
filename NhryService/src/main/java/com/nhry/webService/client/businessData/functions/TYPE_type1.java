...
public class TYPE_type1 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":TYPE_type1", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
    ...
    public static class Factory {
        ...
        public static TYPE_type1 fromString(String value,
            String namespaceURI) {
            TYPE_type1 returnValue = new TYPE_type1();
        ...
        public static TYPE_type1 fromString(
         ...
         */
        public static TYPE_type1 parse(javax.xml.stream.XMLStreamReader reader)
            throws Exception {
            TYPE_type1 object = new TYPE_type1();
