...
/**
 *  EV_GUID_type1 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class EV_GUID_type1 implements org.apache.axis2.databinding.ADBBean {
    ...
    public String toString() {
        return localEV_GUID_type0.toString();
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":EV_GUID_type1", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "EV_GUID_type1", xmlWriter);
            }
        }

        if (localEV_GUID_type0 == null) {
    ...
    public static class Factory {
        ...
        public static EV_GUID_type1 fromString(String value,
            String namespaceURI) {
            EV_GUID_type1 returnValue = new EV_GUID_type1();
        ...
        public static EV_GUID_type1 fromString(
         ...
         */
        public static EV_GUID_type1 parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            EV_GUID_type1 object = new EV_GUID_type1();
