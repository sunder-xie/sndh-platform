...
/**
 *  IT_MTART_type0 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class IT_MTART_type0 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":IT_MTART_type0", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "IT_MTART_type0", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static IT_MTART_type0 parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            IT_MTART_type0 object = new IT_MTART_type0();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"IT_MTART_type0".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (IT_MTART_type0) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
