...
/**
 *  IT_MTART_type1 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class IT_MTART_type1 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":IT_MTART_type1", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "IT_MTART_type1", xmlWriter);
            }
        }
