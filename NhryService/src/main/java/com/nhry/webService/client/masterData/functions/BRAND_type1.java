...
/**
 *  BRAND_type1 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class BRAND_type1 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":BRAND_type1", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "BRAND_type1", xmlWriter);
            }
        }

        if (localBRAND_type0 == null) {
            throw new org.apache.axis2.databinding.ADBException(
                "BRAND_type0 cannot be null !!");
        } else {
            xmlWriter.writeCharacters(localBRAND_type0);
        }
    ...
    public static class Factory {
        ...
        public static BRAND_type1 fromString(String value,
            String namespaceURI) {
            BRAND_type1 returnValue = new BRAND_type1();
        ...
        public static BRAND_type1 fromString(
         ...
         */
        public static BRAND_type1 parse(javax.xml.stream.XMLStreamReader reader)
            throws Exception {
            BRAND_type1 object = new BRAND_type1();
