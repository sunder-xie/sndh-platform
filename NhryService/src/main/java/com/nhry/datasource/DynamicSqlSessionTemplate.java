...
public class DynamicSqlSessionTemplate implements SqlSession {
	 ...
	 * @return
	 */
	public <T> PageInfo<T> selectListByPages(String statement,int pageNum,int pageSize) {
		PageHelper.startPage(pageNum,pageSize); // 核心分页代码 
		return new PageInfo<T>((List<T>) this.selectList(statement));
	}
	 ...
	 * @return
	 */
	public <T> PageInfo<T> selectListByPages(String statement, Object parameter,int pageNum,int pageSize) {
		PageHelper.startPage(pageNum,pageSize); // 核心分页代码 
		return new PageInfo<T>((List<T>) this.selectList(statement,parameter));
	}
