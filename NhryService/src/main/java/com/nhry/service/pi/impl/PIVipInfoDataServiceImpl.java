...
public class PIVipInfoDataServiceImpl implements PIVipInfoDataService {
    ...
    public PISuccessTMessage generateVipInfoData(TVipCustInfo vipCustInfo, TMdAddress address) {
        ...
        try {
            ...
            str_suppl1_type1.setSTR_SUPPL1_type0(vipCustInfo.getAddressTxt());
           ...
           country_type1.setCOUNTRY_type0("001");//(vipCustInfo.getCountry());
            ...
            remarks_type1.setREMARKS_type0(vipCustInfo.getMemoTxt());
            zscrm_memb_upd_dh_input.setREMARKS(remarks_type1);

            ZZFLD00006T_type1 zzfld00006T_type1 = new ZZFLD00006T_type1();
            zzfld00006T_type1.setZZFLD00006T_type0(vipCustInfo.getSalesOrg());
            ...
            deliver_remarks_type1.setDELIVER_REMARKS_type0(vipCustInfo.getDispMemoTxt());
            ...
            zzfld0000B6_type1.setZZFLD0000B6_type0(vipCustInfo.getMilkbox());
            ...
            result.setSuccess("01".equals(flag));
    ...
    public PISuccessTMessage createMemberActivities(MemberActivities memberActivities) {
        try {
            ...
            client.memberActCreate(z_crm_memb_activities_create);
        }catch (Exception e){
            e.printStackTrace();
        }
        return null;
